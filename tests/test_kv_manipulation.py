...
class TestSplinepyKnotVectorManipulation(unittest.TestCase):
    ...
    def test_insert_knot(self):
        ...
        self.bspline.insert_knots(1, [
                .2,
                .5,
                .7,
        ])

        self.nurbs.insert_knots(0, [
                .2,
                .5,
                .7,
        ])
        self.nurbs.insert_knots(1, [
                .2,
                .5,
                .7,
        ])
    ...
    def test_remove_knot(self):
        ...
        self.nurbs.remove_knots(0, [
                .2,
                .5,
                .7,
        ])
        self.nurbs.remove_knots(1, [
                .2,
                .5,
                .7,
        ])
        ...
        self.assertEqual(self.nurbs.knot_vectors, self.ref_nurbs.knot_vectors)
