...
class TestSplinepy(unittest.TestCase):
    ...
    def test_evaluate(self):
        ''' test the correct calculation of the spline coordinates 
        in the physical space (.evaluate()) '''
    ...
    def test_remove_knot(self):
        """ """
        # needs to elevate and then reduce the degree in order to
        # make sure there is a valid solution
        # use .knot_vectors, basis_functions
    ...
    def test_reduce_degree(self):
        ...
        # needs to elevate and then reduce the degree in order to
        # make sure there is a valid solution
        # use .degrees, .knot_vectors, basis_functions
