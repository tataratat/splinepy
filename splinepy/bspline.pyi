...
class BSplineBase(_spline.Spline):
    ...
    def knot_insertion_matrix(self, parametric_dimension: Incomplete | None = None, knots: Incomplete | None = None, beziers: bool = False): ...
    def remove_knots(self, parametric_dimension, knots, tolerance: Incomplete | None = None): ...
