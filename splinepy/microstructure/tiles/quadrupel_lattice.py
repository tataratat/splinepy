...
class QuadrupelLattice(_TileBase):
    ...
    def create_tile(
        ...
        **kwargs,  # noqa ARG002
        ...
        """
        min_thickness = .1
        max_thickness = min_thickness * (1 + 2**.5)
        ...
        if parameters is None:
            ...
            if not (_np.all(parameters > min_thickness) and _np.all(parameters < max_thickness)):
                raise ValueError(
        ...
        for i_derivative in range(n_derivatives + 1):
            ...
            if i_derivative == 0:
                ...
                cl = 0.0
                thickness_horizontal = (coeff_one_half * parameter_sensitivities[0,
                                                                                 0, i_derivative - 1])
                thickness_vertical = (
