...
class Multipatch():
    ...
    def connectivity(self):
        ...
        if self._connectivity is None:
            raise ValueError(
                "No connectivity available, try calling determine_connectivity")
    ...
    def connectivity(self, con):
        ...
        if not ((con.shape[1] == n_boundaries_per_spline)
    ...
    def spline_face_centers(self):
        """
        This property function is a placeholder for once i figure out how to use tracked-arrays
    ...
    def add_boundary_with_function(self, function, only_unassigned=False):
        ...
        relevant_face_centers = self.spline_face_centers[boundary_ids.flatten(
        ),:]
        ...
        try:
            ...
            ValueError(
                "Function is not applicable to array. Function layout"
                " must be f(array<n_face_points,dim>) -> bools<n_face_points>"
                )
