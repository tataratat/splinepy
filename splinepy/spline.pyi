...
class Spline(_SplinepyBase, _core.PySpline):
    ...
    def greville_abscissae(
        self, duplicate_tolerance: Incomplete | None = None
    ): ...
    @property
    ...
    def derivative(
        self, queries, orders, nthreads: Incomplete | None = None
    ): ...
    ...
    def proximities(
        self,
        queries,
        initial_guess_sample_resolutions: Incomplete | None = None,
        tolerance: Incomplete | None = None,
        max_iterations: int = -1,
        aggressive_search_bounds: bool = False,
        nthreads: Incomplete | None = None,
        return_verbose: bool = False,
    ): ...
    def elevate_degrees(self, parametric_dimensions) -> None: ...
    def reduce_degrees(
        self, parametric_dimensions, tolerance: Incomplete | None = None
    ): ...
