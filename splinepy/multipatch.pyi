...
class Multipatch(_SplinepyBase, _PyMultipatch):
    ...
    def __init__(
        self,
        splines: Incomplete | None = None,
        interfaces: Incomplete | None = None,
        *,
    ...
    def set_boundary(
        self, spline_ids, boundary_faces, boundary_id: Incomplete | None = None
    ) -> None: ...
    @property
    def para_dim(self): ...
    @property
    ...
    def boundary_from_function(
        ...
        boundary_id: Incomplete | None = None,
    ) -> None: ...
    @property
